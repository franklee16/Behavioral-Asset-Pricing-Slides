...
\begin{itemize}
\item Turns out that we hate losses about twice as much as we like an equal-sized gain
\item We hate losing
\end{itemize}
\end{column}
...
\item \textbf{The cross-section of stock returns}
  ...
  \item Probability weighting and diminishing sensitivity play the central role
  \end{itemize}
...
\begin{column}{0.55\textwidth}
\begin{itemize}
\item When investors increase allocation to the lottery-stocks, they lose diversification benefits
\item But when allocation get larger, the positive idiosyncratic skewness outweighs the loss of diversification
\end{itemize}
\end{column}
...
\vfill
\centering
\includegraphics[width=0.40\textwidth]{figures/slide27_pic1.png}
\end{frame}
...
\item Wang, Yan, and Yu (JFE, 2016):
  \begin{itemize}
  \item Following Grinblatt and Han (2005), first construct stock-level capital gain overhand (CGO) which simply proxy for whether investors collectively have capital gain for this stock 
...
\vfill
\centering
\includegraphics[width=0.80\textwidth]{figures/slide30_pic1.jpg}
\end{frame}
...
% --- Slide 19a: Instructor's research ---
\begin{frame}[shrink=5]{My Research: Stock Splits as Behavioral Signals}
	\begin{itemize}
		...
		\begin{itemize}
			\item We try to explain why stock splits can be a credible positive signal to markets, even though the costs of implementing stock splits is trivial 
...
\item Choose between:
  ...
  \end{itemize}
\item The modal participants choose R1 and B1, suggesting they believe there are both more red balls and more black balls in Urn C than in Urn U
\end{itemize}
\end{frame}
