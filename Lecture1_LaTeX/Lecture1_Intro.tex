...
\centering
\includegraphics[width=\textwidth]{figures/cape_vs_10yr_real_return.png}

\vspace{0.3em}
\footnotesize
\textbf{Rational explanations?}
\begin{itemize}
\item Rationally-changing forecasts of future risk --- ``rare disaster'' and long-run risk model
...
\vfill
\centering
\includegraphics[width=0.60\textwidth]{figures/Mom12m_decile_bar.png}
\end{frame}
...
\vfill
\centering
\includegraphics[width=0.7\textwidth]{figures/BM_decile_bar.png}
\end{frame}

% --- Slide 16: Cross-section, ctd. ---
\begin{frame}[shrink=5]{The Cross-Section\ --- Value \& momentum across asset classes}
\begin{itemize}
...
\begin{frame}{The Cross-Section\ --- Issuance/repurchase}
	\begin{itemize}
		\item \textbf{The issuance/repurchase anomaly}
		\begin{itemize}
			\item Daniel and Titman (2006) and McLean and Pontiff (2008) show net share issuance negatively predict returns, both in US and globally   
		\end{itemize}
	\end{itemize}
	\vfill
	\centering
...
\vfill
\centering
\includegraphics[width=0.60\textwidth]{figures/GP_decile_bar.png}
\end{frame}
...
\begin{frame}{The Cross-Section\ --- Financial distress}
	\begin{itemize}
		\item \textbf{The financial distress anomaly}
		\begin{itemize}
			\item Similar findings based on OScore measure of financial distress 
		\end{itemize}
	\end{itemize}
	\vfill
	\centering
...
\begin{frame}{The Cross-Section\ --- Accrual and Net Operating Asset}
	...
	\[
	E_t = \underbrace{CF_t}_{\text{cash, persists}} + \underbrace{TA_t}_{\text{accruals, mean-reverts}}
	\]
	...
	\medskip
	\textbf{NOA anomaly (Hirshleifer, Hou, Teoh \& Zhang, 2004).} Rank firms by the \emph{stock} of accumulated accruals:
	\[
	...
	\begin{itemize}
		\item Sloan = \emph{flow} ($\Delta$ accruals, one year); NOA = \emph{stock} (cumulative balance-sheet position) — and NOA \alert{subsumes} the one-year effect.
...
\begin{frame}{Are Anomalies Fake?}
	\begin{itemize}
		\item Some studies (Harvey, Liu and Zhu, 2016; Hou, Xue and Zhang, 2020) criticize the anomaly zoo, aruging most anomalies are results of data mining and probably fake 
		\item Still a few influential studies (Chen and Zimmermann, 2022; Jensen et al, 2023) show anomalies do replicate independently 
	\end{itemize}
	\vfill
	\centering
...
\begin{frame}{Are Anomalies Fake?}
	\begin{itemize}
		\item Jensen et al (2023) show further that most anomalies can replicate out-of-sample in other markets and the alpha magnitudes closely align with US 
	\end{itemize}
	\vfill
	\centering
	\includegraphics[width=0.50\textwidth]{figures/replication_crisis.png}
\end{frame}
...
\begin{frame}{Individual Investors, ctd.}
\begin{itemize}
\item Firms and short sellers tend to be the smart money---both sell stocks with \textbf{low-forecasted returns}, retail investors systematically take the wrong side, and institutions are largely noise 
\end{itemize}
\vfill
\centering
\includegraphics[width=0.85\textwidth]{figures/mclean2025_table4A_forecasted_return_trading.png}\\[0.2em]
...
\item \textbf{Average performance}
  ...
  \item Does this suggest there is no mispricing?
    \begin{itemize}
    \item No one earns abnormal profit, consistent with price being correct
    \end{itemize}
  \end{itemize}
\end{itemize}
\end{frame}
...
\item \textbf{Trading against anomalies}
  ...
  \item Some heterogeneity do exist: Hedge funds and institutions with high turnover seem to exploit anomalies more than other institutions
  \end{itemize}
\end{itemize}
\end{frame}

% --- Slide 41: Closing / preview of Lecture 2 ---
\section{Closing}
...
\item \textbf{Today}: a survey of empirical facts in asset pricing
  ...
  \item Useful datasets to play yourself: Open source cross sectional asset pricing for US markets and Global Factor Returns for global markets 
